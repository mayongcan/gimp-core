...
public class RedisUtils {
	...
	public static final String KEY_PREFIX = Constants.CACHE_REDIS_KEY_PREFIX;
	...
	public static Object hgetObject(String key, String field) {
		...
		try {
			...
			if (jedis.hexists(key, field)) {
				...
				logger.debug("hgetObject {} {} = {}", key, field, value);
			}
		} catch (Exception e) {
			logger.warn("hgetObject {} {} = {}", key, field, value, e);
		} finally {
			returnResource(jedis);
		}
		return value;
	 ...
	 * @return
	 */
	public static Long hsetObject(String key, String field, Object value, int cacheSeconds) {
		Long result = null;
		Jedis jedis = null;
		try {
			jedis = getResource();
			...
			logger.debug("hsetObject {} {} = {}", key, field, value);
		} catch (Exception e) {
			logger.warn("hsetObject {} {} = {}", key, field, value, e);
		} finally {
			returnResource(jedis);
		}
		return result;
