...
public class CriteriaFactory {
     ...
     * @Description : 等于
     */
    public static SimpleExpression equal(String fieldName, Object value, boolean canNull) {
     ...
     * @Description : 大于
     */
    public static SimpleExpression greaterThan(String fieldName, Object value, boolean canNull) {
        if (!canNull && NullUtil.isEmpty(value)) {
            return null;
        }
     ...
     * @Description : 大于等于
     */
    public static SimpleExpression greaterThanOrEqualTo(String fieldName, Object value, boolean canNull) {
        if (!canNull && NullUtil.isEmpty(value)) {
            return null;
        }
     ...
     * @Description : 小于
     */
    public static SimpleExpression lessThan(String fieldName, Object value, boolean canNull) {
        if (!canNull && NullUtil.isEmpty(value)) {
            return null;
        }
     ...
     * @Description : 小于等于
     */
    public static SimpleExpression lessThanOrEqualTo(String fieldName, Object value, boolean canNull) {
        if (!canNull && NullUtil.isEmpty(value)) {
            return null;
        }
     ...
     * @Description : 不等于
     */
    public static SimpleExpression notEqual(String fieldName, Object value, boolean canNull) {
        if (!canNull && NullUtil.isEmpty(value)) {
            return null;
        }
