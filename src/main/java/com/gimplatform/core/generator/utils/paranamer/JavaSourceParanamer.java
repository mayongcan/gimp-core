package com.gimplatform.core.generator.utils.paranamer;
        ...
        try {
            ...
            try {
                if (javaSourceInputStream != null) {
                    return parser.parseJavaFileForParamNames(methodOrConstructor, FileUtils.toString(javaSourceInputStream));
                }
