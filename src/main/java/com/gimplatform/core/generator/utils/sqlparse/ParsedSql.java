...
public class ParsedSql {
	...
	/**
	 * Return all of the parameters (bind variables) in the parsed SQL
	 * statement. Repeated occurences of the same parameter name are included
	 * here.
	 */
	 ...
	 *            List)
	 * @return the start index and end index, combined into a int array of
	 *         length 2
	 */
