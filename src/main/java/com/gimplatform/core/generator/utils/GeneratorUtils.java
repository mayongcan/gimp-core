...
public class GeneratorUtils {
	 ...
	 */
	public static boolean isFoundInsertLocation(GeneratorControl generatorControl, Template template, Map<String, Object> model, File outputFile,
	...
	public static Configuration newFreeMarkerConfiguration(List<File> templateRootDirs, String defaultEncoding,
		...
		logger.info("set Freemarker.autoIncludes:" + availableAutoInclude + " for templateName:" + templateName
