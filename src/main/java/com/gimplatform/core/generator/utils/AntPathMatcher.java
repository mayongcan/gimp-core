...
public class AntPathMatcher {
     ...
     * <p>
     * This implementation simply concatenates the two patterns, unless the first pattern contains a file extension match (such as {@code *.html}. In that case, the second pattern should be included in
     * the first, or an {@code IllegalArgumentException} is thrown.
     * <p>
     * For example:
     * <table>
     * <tr>
     ...
     * <p>
     * The returned <code>Comparator</code> will {@linkplain java.util.Collections#sort(java.util.List, Comparator) sort} a list so that more specific patterns (without uri templates or wild cards) come
